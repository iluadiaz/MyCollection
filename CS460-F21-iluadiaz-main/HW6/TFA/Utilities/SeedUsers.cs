    ...
    public static class SeedUsers
    {
        ...
        public static async Task Initialize(IServiceProvider serviceProvider, UserInfoData[] seedData, string testUserPw)
        {
            try
            {
                ...
                using (var context = new TFAIdentityDbContext(serviceProvider.GetRequiredService<DbContextOptions<TFAIdentityDbContext>>()))
                {
                    ...
                    foreach (var u in seedData)
                    {
                        ...
                        //AspNetUsers fu = new AspNetUsers { AspnetIdentityId = identityID, FirstName = u.FirstName, LastName = u.LastName };
                        //if (!context.AspNetUsers.Any(x => x.AspnetIdentityId == fu.AspnetIdentityId && x.FirstName == fu.FirstName && x.LastName == fu.LastName))
                        //{
