...
namespace TFA.Models
{
    ...
    public class RaceResultDisplay
    {
        ...
        public string TimeFormattedHHMMSS { get => TimeSpan.FromSeconds(Time).ToString(@"hh\:mm\:ss\.ff").TrimStart('0', ':', '0', ':'); }
        ...
        public override bool Equals(Object obj)
        {
            ...
            else
            {
                ...
                return (TrackEventName == r.TrackEventName) &&
                        (TimeFormattedHHMMSS == r.TimeFormattedHHMMSS) &&   // compare formatted time to avoid representation errors
                        (MeetDate == r.MeetDate) &&
                        (MeetName == r.MeetName);
            }
        }
        ...
        public override int GetHashCode()
        {
            //return (TrackEventName + TimeFormattedHHMMSS + MeetName).GetHashCode();
            return (TrackEventName + TimeFormattedHHMMSS + MeetDateFormatted + MeetName).GetHashCode();
        }
    }
}